...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url();?>resources/css/ui-lightness/jquery-ui-1.10.0.custom.min.css" rel="stylesheet">    
    
    <link href="<?php echo base_url();?>resources/css/base-admin-2.css" rel="stylesheet">
    <link href="<?php echo base_url();?>resources/css/base-admin-2-responsive.css" rel="stylesheet">
