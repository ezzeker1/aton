                        ...
                        foreach ($images as $image) {
                            ...
                            <li>
                                ...
                                <a class="btn btn-small btn-danger confirm-popup btn-warning" 
                                   href="<?php echo base_url('admin/gallery/delete/' . basename($image['url']) . '/aboutus?backuri=pages/aboutus'); ?>">
            ...
            <?php   if (count($images) < 3) { ?>
                <div class="widget stacked">			
                    <div class="widget-header">
                        ...
                        <h3>Add new About Us photo</h3>
                    </div> <!-- /widget-header -->	
                    <div class="widget-content">
                        <br />
                        <form data-validate="parsley"  method="POST"  enctype="multipart/form-data" action="<?php echo base_url('admin/gallery/add/aboutus?backuri=pages/aboutus'); ?>" id="validation-form" class="form-horizontal">
                            <fieldset>
