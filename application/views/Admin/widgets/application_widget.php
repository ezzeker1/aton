                        ...
                        foreach ($images as $image) {
                            ...
                            <li>
                                ...
                                <a class="btn btn-small btn-danger confirm-popup btn-warning" 
                                   href="<?php echo base_url('admin/gallery/delete/' . basename($image['url']) . '/applications/'.$id.'?backuri=applications/edit/'.$id); ?>">
            ...
            <?php   if (count($images) < 6) { ?>
                <div class="widget stacked">			
                    <div class="widget-header">
                        ...
                        <h3>Add applications photos</h3>
                    </div> <!-- /widget-header -->	
                    <div class="widget-content">
                        <br />
                        <form data-validate="parsley"  method="POST"  enctype="multipart/form-data" action="<?php echo base_url('admin/gallery/add/applications/'.$id.'?backuri=applications/edit/'.$id); ?>" id="validation-form" class="form-horizontal">
                            <fieldset>
                                <div class="control-group">
                                    <label class="control-label" for="name">Caption</label>
                                    <div class="controls">
                                        <input data-required="true" data-type="alphanum" data-trigger="change" type="text" class="input-large" name="caption" id="name">
                                    </div>
                                </div>
                                <div class="control-group">
