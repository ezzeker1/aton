      	...
      	<div class="span12">
      		...
      		<div class="widget stacked">
				...
				<div class="widget-content">
                                     ...
                                     <form  enctype="multipart/form-data"  action="<?php echo base_url('admin/pages/'.$this->uri->segment(3)); ?>" method="post" id="validation-form" class="form-horizontal ">
                                   <?php echo form_hidden('page_name', $page->name); ?>
