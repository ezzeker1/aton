                    ...
                    <div class="navbar navbar-inverse">        
                        <div class="navbar-inner span12"> 
                            ...
                            <div style="margin-left: 5%;" class="flags pull-left">
                                <ul class="clearfix">
                                    <li><a href="<?php echo base_url('home/change_locale/english/back_url/' . $this->uri->uri_string()); ?>"><img src="<?php base_url(); ?>resources/site/images/uk-flag.png" width="32" height="25" alt="uk-flag"></a></li>
                                    <li><a href="<?php echo base_url('home/change_locale/arabic/back_url/' . $this->uri->uri_string()); ?>"><img src="<?php base_url(); ?>resources/site/images/arabic-flag.png" width="32" height="25" alt="arabic-flag"></a></li>
                                </ul>
                            </div>
