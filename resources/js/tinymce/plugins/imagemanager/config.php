<?php
        ...
        $mcImageManagerConfig['upload.format'] = '30x30=small/%f.%e,41x41=medium/%f.%e,97x84=large/%f.%e'; 
		// $mcImageManagerConfig['upload.format'] = '30x30=small/%f_%w_%h.%e,41x41=medium/%f_%w_%h.%e,97x84=large/%f_%w_%h.%e'; 
        ...
        $mcImageManagerConfig['filesystem.local.allow_override'] = "mc_access";
